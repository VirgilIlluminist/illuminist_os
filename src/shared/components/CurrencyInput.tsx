...
export default function CurrencyInput({
  ...
  return (
    <div className="relative w-full">
      ...
      />
      {isFocused && (
        <span className="absolute left-0 -bottom-4.5 text-[9px] text-[#d4af37] font-mono tracking-wider animate-fadeIn z-10 bg-black px-1 py-0.5 rounded border border-white/5 whitespace-nowrap">
